    ...
    <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #000000; color: #e8edf2; border-radius: 12px; overflow: hidden;">
      ...
      <div style="padding: 2rem 2.5rem 2.5rem;">
        ...
        <div style="background: #0d1117; border: 1px solid #1a1a1a; border-radius: 10px; padding: 1.5rem;">
          ...
          <p style="margin: 0.5rem 0;"><span style="color: #f5c542; font-weight: bold;">Step 2</span> — Email the screenshot to <strong style="color: #2dd4bf;">frictionteam@noverseinc.com</strong></p>
        ...
        <p style="margin-top: 2rem;">If you run into any issues, email us at <strong style="color: #2dd4bf;">frictionteam@noverseinc.com</strong> — we're happy to help.</p>
